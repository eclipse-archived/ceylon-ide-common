...
import org.eclipse.ceylon.compiler.js.loader {
    NpmAware,
    NpmPackage
}
    ...
    shared actual Map<String, String> classesToSources {
        if (_classesToSources.empty && nameAsString == "java.base") {
            ...
            _classesToSources = HashMap {
                ...
                if (key.startsWith("org/eclipse/ceylon/compiler/java/language/"))
                key.replace("org/eclipse/ceylon/compiler/java/language/", "java/lang/") -> item
            };
        }
