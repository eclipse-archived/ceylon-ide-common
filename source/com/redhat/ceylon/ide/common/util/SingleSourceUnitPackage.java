...
public class SingleSourceUnitPackage extends com.redhat.ceylon.model.typechecker.model.Package {
    ...
    private boolean mustSearchInSourceFile(Unit modelUnit) {
        if (modelUnit instanceof com.redhat.ceylon.ide.common.model.CeylonUnit) {
            com.redhat.ceylon.ide.common.model.CeylonUnit ceylonUnit = (com.redhat.ceylon.ide.common.model.CeylonUnit) modelUnit;
            ceylon.language.String fullPathOfModelSourceUnit = ceylonUnit.getCeylonSourceFullPath();
            if (fullPathOfModelSourceUnit != null && fullPathOfModelSourceUnit.toString().equals(fullPathOfSourceUnitToTypecheck)) {
                return true;
            }
        }
        return false;
