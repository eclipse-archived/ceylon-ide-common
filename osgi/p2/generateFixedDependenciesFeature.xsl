...
<feature
      id="{$featureId}"
      label="Ceylon IDE Common Code Binary Dependencies Feature"
      version="{$featureVersion}"
      provider-name="Red Hat">
   <description>
      The Ceylon IDE Common Code Binary Dependencies Feature provides only the fixed binary dependencies of the Ceylon IDE Common Code.
