...
<feature
      id="{$featureId}"
      label="Ceylon IDE Common Code Feature"
      version="{$featureVersion}"
      provider-name="Red Hat">
   <description>
      The Ceylon IDE Common Code Feature provides all the OSGI bundles required to use the IDE common code (https://github.com/ceylon/ceylon-ide-common) inside Eclipse.
   </description>
